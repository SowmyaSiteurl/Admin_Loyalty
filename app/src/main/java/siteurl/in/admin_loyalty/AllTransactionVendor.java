...
public class AllTransactionVendor extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener{

    private TabLayout tabLayout;
    private ViewPager viewPager;
    SharedPreferences loginpref;
    SharedPreferences.Editor editor;
    String userdata,loginuserid,sessionid,uid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.all_transaction_vendor);
        alertDialog = new Dialog(this);
        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);

        //getting data from other login Activity
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new purchased_point(), "Points Purchased");
        adapter.addFragment(new PointsGivenToBuyer(), "Points Given");
